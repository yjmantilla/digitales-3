...
#define LCD_ADDRESS_PT          @0x00000000   // Dirección puerto A (PTAD)
#define LCD_ADDRESS_DDR         @0x00000001   // Dirección puerto A (PTADD)
...
extern volatile LCD_PtcStr   _LCD_Port_Data_Dir LCD_ADDRESS_DDR; // Dirección Puerto
